                    ...
                    <div className="container">
                        {slugged == undefined && (
                            ...
                            <div className='col-md-2'>
                                <button type='button' onClick={() => setSekme([])} className={`btn btn-secondary btn-block`}>Tümü</button>
                            </div>
                            <div className='col-md-2'>
                                <button type='button' onClick={() => handleSekme('analiz-dizisi')} className={`btn btn-secondary btn-block`}>Analiz Dizisi</button>
                            </div>
                            <div className='col-md-2'>
                                <button type='button' onClick={() => handleSekme('degerlendirme-dizisi')} className={`btn btn-secondary btn-block`}>Değerlendirme Dizisi</button>
                            </div>
                            <div className='col-md-2'>
                                <button type='button' onClick={() => handleSekme('etkinlik-raporları')} className={`btn btn-secondary btn-block`}>Etkinlik Raporları</button>
                            </div>
                            <div className='col-md-2'>
                                <button type='button' onClick={() => handleSekme('guncel-yayinlar-dizisi')} className={`btn btn-secondary btn-block`}>Güncel Yayınlar Dizisi</button>
                            </div>
                            </div>
                        )}
