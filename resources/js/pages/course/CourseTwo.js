                    ...
                    <div className="container">
                        <div className="d-flex justify-content-center">
                            <div className="col-md-2">
                                <button onClick={() => handleSekme('2022')} className="btn btn-secondary btn-block">2022</button>
                            </div>
                            <div className="col-md-2">
                                <button onClick={() => handleSekme('2021')} className="btn btn-secondary btn-block">2021</button>
                            </div>
                            <div className="col-md-2">
                                <button onClick={() => handleSekme('2020')} className="btn btn-secondary btn-block">2020</button>
                            </div>
                            <div className="col-md-2">
                                <button onClick={() => handleSekme('2019')} className="btn btn-secondary btn-block">2019</button>
                            </div>
                            <div className="col-md-2">
                                <button onClick={() => handleSekme('2018')} className="btn btn-secondary btn-block">2018</button>
                            </div>
                            <div className="col-md-2">
                                <button onClick={() => setSekme([])} className="btn btn-secondary btn-block">Tümü</button>
                            </div>
