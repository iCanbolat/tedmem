                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="inner text-center">
                            <SectionTitle
                                classes = "text-center"
                                slogan = "Bülten ve yayınlarından haberdar olmak İÇİN "
                                title = "Üye Olabilirsiniz"
                            />
                            <div className="newsletter-form newsletter-form-style-1 mt--60 mt_md--30 mt_sm--30 position-relative">
                                <div className="input-box text-start">
                                    <input className="large-input-box" type="email" placeholder="E-mail adresinizi girin..." />
                                    <div className="mail-icon">
                                        <i className="icon-mail-open-line"></i>
                                    </div>
                                    <button className="edu-btn">Abone Ol<i className="icon-arrow-right-line-right"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
